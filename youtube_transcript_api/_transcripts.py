...
class TranscriptListFetcher(object):
    ...
    def _fetch_html(self, video_id):
        response = self._http_client.get(WATCH_URL.format(video_id=video_id), headers={'Accept-Language': 'en-US'}, verify=False)
...
class Transcript(object):
    ...
    def fetch(self, preserve_formatting=False):
        ...
        """
        response = self._http_client.get(self._url, headers={'Accept-Language': 'en-US'}, verify=False)
